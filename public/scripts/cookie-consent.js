...
// Debug: log when consent script is loaded
console.debug('[cprep] cookie-consent.js loaded');
...
(function () {
  ...
  function applyConsent(consent) {
    ...
    window.__cprep_consent_state = consent ? JSON.stringify(consent) : 'none';
  }
  ...
  function init() {
    ...
    const existing = getConsent();
    if (existing) { applyConsent(existing); hideBanner(); return; }
